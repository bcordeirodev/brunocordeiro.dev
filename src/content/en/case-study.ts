  ...
  chapters: [
    ...
    },
    {
      ...
      deploy: {
        ...
        decisions: [
          "build runs on the runner, not the server: compiling on the droplet would steal CPU and RAM from live traffic",
          "rsync ships deploy artefacts only — source, toolchain and node_modules never reach the server",
          "the migrate must be backward-compatible: blue keeps serving while green boots, both on the same database",
