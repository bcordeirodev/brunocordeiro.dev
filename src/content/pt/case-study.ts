...
export const caseStudy: CaseStudy = {
  ...
  chapters: [
    ...
    },
    {
      ...
      deploy: {
        caption: "Do branch à troca de cor — e por que cada etapa é assim.",
        bands: {
        ...
        gate: "daqui para baixo é publicação — o gatilho é a tag",
        steps: [
          { title: "tag", sub: "v2.16.0, à mão" },
          { title: "build", sub: "runner GitHub · 2m03s" },
          { title: "ghcr", sub: "imagem versionada" },
          { title: "rsync", sub: "só artefatos de deploy" },
        ],
        ...
        decisions: [
          "build no runner do GitHub: o droplet tem 2 vCPU e 3,8 GB — compilar ali tiraria CPU de quem está sendo atendido",
          "o rsync leva só composes, scripts e config — código-fonte e toolchain não chegam ao servidor",
          "a infra (postgres, redis, alloy) não é tocada: o deploy antigo derrubava o banco junto com a app",
          "migrate online exige retrocompatibilidade; migration destrutiva vai em modo offline, ~20s, marcada por teste",
          "o health check bate no nginx e numa rota do Laravel — 200 do nginx não prova que o PHP-FPM subiu",
          "rollback é a mesma esteira com a tag anterior — um caminho de emergência à parte seria o menos testado",
        ],
