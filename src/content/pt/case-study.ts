  ...
  chapters: [
    ...
    },
    {
      ...
      deploy: {
        ...
        decisions: [
          "build no runner, nunca no servidor: compilar no droplet roubaria CPU e RAM de quem está sendo atendido",
          "o rsync leva só os artefatos de deploy — código-fonte, toolchain e node_modules não chegam ao servidor",
          "migrate retrocompatível: blue segue atendendo enquanto green sobe, e as duas versões falam com o mesmo banco",
